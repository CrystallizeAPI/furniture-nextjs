...
# Variables
DOCKER_COMPOSE_ARGS := COMPOSE_PROJECT_NAME=furnituremix-nextjs COMPOSE_FILE=provisioning/dev/docker-compose.yaml
...
list:
	@echo "******************************"
	@echo "${RED}Next JS - ${YELLOW}Available targets${RESTORE}:"
